package com.vlasova.cleverbank.pool;

import com.vlasova.cleverbank.exception.ConnectionPoolException;
...
public class ConnectionPool {
    private static final String DB_CONNECTION_POOL_PROPERTIES = "connectionPool.yaml";
